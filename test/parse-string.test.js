...
var old_mappings = {
    ...
    '94eeff': { hue: 192.16510903426794, saturation: 100, y0: 0, y1: 1 },
    'ff7f00': { hue: 30.29738562091503, saturation: 100, y0: 0, y1: 1 },
    '#4c2d00': { hue: 36.01973684210527, saturation: 100, y0: 0, y1: 1 }
};
...
var new_mappings = {
    ...
    '.5x0;1x0':{ h: [.5,0], s: [1,0] },
    'ffffff': { h:[0,0],s:[0,0],l:[0,1] },
    'ff7f00': { h: [30.29738562091503/365,30.29738562091503/365], s: [1,1], l:[0,1] },
    '#4c2d00': { h: [36.01973684210527/365,36.01973684210527/365], s: [1,1], l: [0,1] }
}

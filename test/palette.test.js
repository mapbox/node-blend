...
var palettes = [
    new blend.Palette(fs.readFileSync('test/fixture/palette-1.pal'), 'rgb')
];
...
describe('palette creation', function() {
    ...
    it('should create a palette from an .act file', function() {
    ...
    it('should create a palette with 256 colors from an .act file', function() {
